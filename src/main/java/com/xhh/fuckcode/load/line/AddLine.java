...
public class AddLine extends DataLine {
    ...
    public int run() {
        ...
        if (getObjects()[0] instanceof Integer && getObjects()[1] instanceof Integer) {
            ...
            //System.out.println("int和int相加"+getSave());
            return 0;
            ...
            //System.out.println("double和double相加");
            return 0;
            ...
            //System.out.println("int和double相加");
            return 0;
